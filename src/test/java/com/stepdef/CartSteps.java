...
public class CartSteps {
	...
	@And("I clear the wishlist before order new products")
	public void iClearTheProductsBeforeOrder() throws Exception {
		new CartPage().iRemoveAllProductsFromCartInitially();
